def modelConstants(techno,prix_H2,P_electro_max,N,H2_target,Revente):
    ...
    constant_dic = {
        ...
        "P_electro_max": P_electro_max,   # Maximum electrolyser power (MW)
        ...
        "YIELD_H2": YIELD_H2,             # kg / MWh
        "H2_target": H2_target,           # Annual H2 production target (kg)
    }
    return constant_dic
